...
export default function Home() {
  ...
  return (
    <div className="relative flex-1 bg-neutral-50 dark:bg-[#050505] text-neutral-900 dark:text-white flex flex-col items-center justify-center p-6 overflow-hidden select-none transition-colors duration-300 animate-page-reveal">
      ...
      <div className="responsive-wrapper z-10">
        
        {/* TÍTULO PRINCIPAL */}
        <h1 className="text-2xl font-black italic text-amber-500 mb-10 tracking-[0.3em] drop-shadow-[0_0_18px_rgba(245,158,11,0.25)] font-mono uppercase text-center w-full">
          Hacking Lab | CIDADE ALTA
        </h1>

        {/* GRID DE MÓDULOS */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-2xl font-mono">
