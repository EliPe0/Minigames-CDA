...
export default function Home() {
  ...
  return (
    <div className="relative flex-1 bg-[#050505] text-white flex flex-col items-center justify-center p-6 overflow-hidden select-none animate-page-reveal">
      
      {/* BACKGROUND EFFECTS */}
      <div 
        className="absolute inset-0 bg-cover bg-center pointer-events-none opacity-[0.003] grayscale mix-blend-screen"
      ...
      <button
        ...
        className="absolute top-6 right-6 z-20 flex items-center gap-2 px-4 py-2 bg-neutral-900/30 border border-neutral-800 rounded-xl text-neutral-400 hover:text-amber-400 transition-all duration-200 font-mono text-[11px] font-bold uppercase tracking-wider hover:shadow-lg hover:shadow-amber-500/20 active:scale-[0.97]"
      >
      ...
      <div className="responsive-wrapper z-10 w-full max-w-xl">
        ...
        <div className="text-center mb-8 max-w font-mono animate-page-reveal">
          <p className="text-[13px] font-black uppercase tracking-[0.3em] text-neutral-500 mb-2">
            Sistema de Treinamento
          </p>
          <p className="text-[12px] leading-relaxed text-neutral-500 dark:text-neutral-400 font-medium px-4">
            Selecione um dos módulos abaixo para acessar os desafios de cada sistema do servidor Cidade Alta. Cada módulo possui um objetivo específico e um nível de dificuldade distinto, proporcionando uma experiência de treinamento completa.
          </p>
        </div>
        ...
        <div className="relative w-full flex items-center justify-center gap-4">
          ...
          <button 
            onClick={prevSlide}
            className="p-3 bg-[#090909] border border-neutral-900 rounded-xl text-neutral-400 hover:text-white hover:scale-105 hover:border-neutral-700 active:scale-95 transition-all shadow-sm shrink-0"
          >
          ...
          {/* CARD CENTRAL*/}
          <div key={currentIndex} className="w-full bg-[#090909] border border-neutral-900 rounded-2xl overflow-hidden flex flex-col shadow-md animate-page-reveal">
            
            {/* TELA DE PREVIEW SUPERIOR */}
            <div className="w-full h-52 bg-neutral-950 relative overflow-hidden border-b border-neutral-900/40 transition-colors">
              <img 
            ...
            <div className="p-6 flex flex-col justify-between font-mono">
              <div className="mb-6">
                ...
                <p className="text-neutral-500 text-[11px] leading-relaxed text-left">
        ...
        <div className="flex justify-center gap-2 mt-6">
          {modules.map((_, idx) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-300 ${idx === currentIndex ? 'w-6 bg-amber-500 shadow-[0_0_10px_rgba(245,158,11,0.5)]' : 'w-2 bg-neutral-800'}`}
            />
          ))}
        </div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 animate-blur-fade">
          ...
          <div className="max-w-xl w-[95%] max-h-[90vh] bg-[#0c0c0c] border border-neutral-800 rounded-2xl shadow-2xl relative overflow-hidden animate-elastic-pop flex flex-col font-mono cursor-default">
            ...
            <div className="p-6 sm:p-8 flex flex-col gap-5 overflow-y-auto">
              ...
              <p className="text-neutral-400 text-xs sm:text-[13px] leading-relaxed tracking-wide text-justify">
                ...
                Em caso de dúvidas, sugestões ou problemas, entre em contato por meio do repositório do projeto no GitHub. Caso tenha interesse em conhecer o servidor <span className="text-purple-400">Cidade Alta</span>, utilize línk disponibilizado abaixo.
              </p>
              
              <div className="bg-[#050505] border border-neutral-200 dark:border-neutral-800 p-4 sm:p-5 rounded-xl flex flex-col gap-4 mt-2">
